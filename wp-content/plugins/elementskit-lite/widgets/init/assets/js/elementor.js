        ...
        e.ajax({
          ...
          success: function (s) {
            t.removeClass("ekit-ajax-loading"),
              i.replaceWith(s),
              n.removeClass(a).addClass(o).removeAttr("style"),
  ...
  let n = {
    ...
    Progressbar: function (e) {
      ...
      ElementsKit_Helper?.observeElement(t[0], (e) => {
        i.animateNumbers(s, !0, o), n.animate({ width: s + "%" }, o);
      });
    },
    Funfact: function (e) {
      ...
      ElementsKit_Helper?.observeElement(t[0], (e) => {
        "static" == i
          ? n.animateNumbers(s, !0, o)
          : new Odometer({ el: n[0], value: 0, duration: o }).update(s);
      });
    },
      ...
      if (l.length) {
        ...
        l.theFinalCountdown(r.ekitCountdown, function (e) {
          m(c.s, e.offset.seconds, s),
            ...
            m(c.h, e.offset.hours, o),
            m(c.d, e.offset.days, a),
    ...
    Image_Comparison: function (e) {
      ...
      for (let e in n)
        n.hasOwnProperty(e) &&
          "string" == typeof n[e] &&
          (n[e] = ElementsKit_Helper.escapeHtml(n[e]));
      t.imagesLoaded(function () {
        var e = {
          ...
          barColor:
            !0 === o.gradientChart
              ? function (e) {
                  ...
                  return (
                    i.addColorStop(0, o.gradientColor1),
                    i.addColorStop(1, o.gradientColor2),
                    i
                  );
                }
              : o.barColor,
            ...
            { value: t },
            {
              ...
              step: function () {
                o.text(Math.floor(this.value)),
                  n &&
                    o.text(o.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
              },
              complete: function () {
                parseInt(o.text(), 10) !== t &&
                  (o.text(t),
                  n &&
                    o.text(
