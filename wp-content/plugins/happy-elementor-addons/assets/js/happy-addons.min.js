      ...
      var t = elementorModules.frontend.handlers.Base,
        n = t.extend({
          ...
          getSlickSettings: function () {
            var e =
              1 == c('html[dir="rtl"]').length || c("body").hasClass("rtl");
        ...
        i = t.extend({
          onInit: function () {
            t.prototype.onInit.apply(this, arguments),
              this.run(),
              this.runFilter(),
              d.on("resize", h(this.run.bind(this), 100));
          },
        ...
        a = t.extend({
          ...
          runFilter: function () {
            var t = this,
              n = this.getLightBoxSettings(),
              i = { lastRow: this.getElementSettings("last_row") };
            u(t.$element, function (e) {
              "*" !== e && ((i.lastRow = "nojustify"), (n.selector = e)),
                (i.filter = e),
                t.elements.$container.justifiedGallery(i),
                g(n);
            });
          },
          onElementChange: function (e) {
        ...
        i =
          ...
          c("body").on(
            ...
            function () {
              ...
              (a.id = "happy-addons-wrapper-link-" + n),
                (a.href = i.url),
                (a.target = i.is_external ? "_blank" : "_self"),
                (a.rel = i.nofollow ? "nofollow noreferer" : ""),
                (a.style.display = "none"),
                document.body.appendChild(a),
                (e = document.getElementById(a.id)).click(),
          ...
          c.each(
            {
              ...
              "ha-threesixty-rotation.default": function (i) {
                var e,
                  a = i.find(".ha-threesixty-rotation-inner"),
                  t = a.data("selector"),
                  n = a.data("autoplay"),
                  ...
                  d = circlr(t, { play: !0 });
                "on" === n
                  ? ((e = i.find(".ha-threesixty-rotation-autoplay")).on(
                      "click",
                      function (e) {
                  ...
                  o.on("click", function (e) {
                    i.find("img").each(function () {
                      -1 !== c(this).attr("style").indexOf("block") &&
                        (HappySimplaMagnify(c(this)[0], s),
                        o.css("display", "none"),
                        r.remove());
                    });
                  }),
                      ...
                      if ("yes" == x) {
                        var t = function (e) {
                          ...
                          n = function (e) {
                            ...
                            return (
                              ...
                              (n = i.includes("a") ? n.toLowerCase() : n)
                            );
                          },
                          i =
                        ...
                        v.css("display", "none"),
                          ...
                          h &&
                            ...
                            v.find("img").attr("alt", a)),
                          a && (u.removeAttr("style"), u.text(a)),
                          s &&
                            (f.removeAttr("style"),
                            f.find("span.ha-ec-event-guest").text(s)),
                          l &&
                            (p.removeAttr("style"),
                            p.find("span.ha-ec-event-location").text(l)),
                        ...
                        if (e.event.url && e.event.extendedProps.external)
                          return (
                            e.jsEvent.preventDefault(),
                            (u = b.data("id")),
                            ((a = document.createElement("a")).id =
                              "happy-even-calender-link-" + u),
                            (a.href = e.event.url),
                            (a.target = e.event.extendedProps.external
                              ? "_blank"
                              : "_self"),
                            (a.rel = e.event.extendedProps.nofollow
                              ? "nofollow noreferer"
                              : ""),
                            (a.style.display = "none"),
                            document.body.appendChild(a),
                            (w = document.getElementById(a.id)).click(),
                  ...
                  (n = e.find(".ha-ia-item")).each(function (e, t) {
                    c(this).on("click", function (e) {
                      c(this).hasClass("active") ||
                        (n.removeClass("active"), c(this).addClass("active"));
                    });
                  });
              },
              "ha-content-switcher.default": function (e) {
                ...
                "button" == l.data("design-type")
                  ? ((n = l.find(".ha-cs-button")),
                    (i = l.find(".ha-cs-content-section")),
                    n.each(function (e, t) {
                      c(this).on("click", function (e) {
                        e.preventDefault(),
                          c(this).hasClass("active") ||
              ...
              "ha-member.default": function (e) {
                ...
                0 < i.length &&
                  ((t = i.find(".ha-member-lightbox-close")),
                  n.on("click", function () {
                    i.addClass("ha-member-lightbox-show");
                  }),
                  i.on("click", function (e) {
                    !i.hasClass("ha-member-lightbox-show") ||
                      (e.target != i[0] &&
                        e.target != t[0] &&
                        e.target != t.find("i.eicon-editor-close")[0]) ||
                      i.removeClass("ha-member-lightbox-show");
                  }));
              },
              "ha-creative-button.default": function (e) {
                ...
                0 < t.length &&
                  0 < a.length &&
                  (a[0].addEventListener("transitionend", function () {
                  ...
                  t[0].addEventListener("mouseenter", function (e) {
                    ...
                    e = a[0].offsetWidth;
                    (a[0].style.width = "0"),
                      window.getComputedStyle(a[0]).transform,
                      (a[0].style.width = "".concat(e, "px"));
                  }),
                  t[0].addEventListener("mouseleave", function (e) {
                    e.currentTarget.classList.remove("hover"),
                      (a[0].style.width = "".concat(a[0].offsetWidth, "px")),
                      window.getComputedStyle(a[0]).transform,
                      (a[0].style.width = "");
                  }));
              },
                ...
                "yes" === i &&
                  d.scroll(function () {
                    ...
                    o <= e
                      ...
                      : a < e && n.removeClass("table-sticky");
                  });
              },
            },
            function (e, t) {
            ...
            function (e) {
              ...
              function t() {
                jQuery(window).width() < 768
                  ? (i.removeClass("ha-navigation-menu-wrapper"),
                    i.addClass("ha-navigation-burger-menu"),
                    i
                  ...
                  : (i.addClass("ha-navigation-menu-wrapper"),
                    i.removeClass("ha-navigation-burger-menu"),
                    i.find("ul.menu").removeAttr("style"),
                    i.find("ul.sub-menu").removeAttr("style"));
              }
              jQuery(window).width() < 1025 &&
                767 < jQuery(window).width() &&
                i.find(".ha-submenu-indicator-wrap").on("click", function (e) {
                  e.preventDefault();
                  e = c(this).parent("li.menu-item-has-children");
                  e && e.children("ul.sub-menu").slideToggle();
                }),
        ...
        l =
          ...
          t.extend({
            ...
            getReadySettings: function () {
              ...
              return (
                t && (e.scroll_type = t), c.extend({}, this.getSettings(), e)
              );
            },
            run: function () {
              ...
              "undefined" == typeof gsap ||
                ...
                ("horizontal_line_mask" === a || "vertical_line_mask" === a
                  ? (c(n).each(function (e) {
                      var t = c(this);
                      i[e] = new SplitType(t, { types: "lines, words" });
                    }),
                    c(n)
                      .find(".line")
                      .each(function (e) {
                  ...
                  : "horizontal_line_highlight" === a
                  ? c(n).each(function (e) {
                      var t = c(this);
                      i[e] = new SplitType(t, { types: "words, chars" });
                    })
                  : new SplitType(n, { types: "lines, words" }),
                "horizontal_line_mask" === a || "vertical_line_mask" === a
                  ? t.find(".line").each(function (e, t) {
                      var n,
                        i = c(t).find(".ha-line-mask");
                      i.length <= 0 ||
                        (c(t).addClass("mask-active"),
                        (n =
                          "horizontal_line_mask" === a
                            ? { width: "0%" }
                            : { height: "0%" }),
                        gsap
                          .timeline({
